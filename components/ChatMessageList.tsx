...
export function ChatMessageList(props: {
  ...
  onRestartConversation: (conversationId: string, history: DMessage[]) => void;
  sx?: SxProps;
}) {
  // state
  ...
  const handleMessageDelete = (messageId: string) => props.conversationId && deleteMessage(props.conversationId, messageId);
